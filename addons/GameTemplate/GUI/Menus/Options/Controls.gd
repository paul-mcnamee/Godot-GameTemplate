...
var ActionBind:PackedScene = preload("res://addons/GameTemplate/GUI/Menus/ReBindSection/ActionBind.tscn")
var ControlBind:PackedScene = preload("res://addons/GameTemplate/GUI/Menus/ReBindSection/ControlBind.tscn")
